...
namespace structurizr.Views.Dynamic
{
    public static class ResidentWeb2LoginDynamicView
    {
        public static void Initialize(ViewSet views)
        {
            ...
            residentLoginProcessDynamicView.Add(Actors.Resident, "Resident logs in", PayContainers.ResidentUiWeb1PayLease);
            ...
            residentLoginProcessDynamicView.Add(NonZegoSystems.CleverTapSystem, "sends activation email", Actors.Resident);
